  ...
  return (
    <motion.div name="about" id="about" className="about-container">
      ...
      >
        ...
        I am Chakradhar Nadikota, born in India, and my fascination with computers began during my early years.
          Completing my Bachelor's in Computer Science and Engineering from Jawaharlal Nehru Technological University, Kakinada, was a

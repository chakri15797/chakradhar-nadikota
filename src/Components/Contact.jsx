...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceID = 'service_6erlihj';
    const templateID = 'template_v74kybo';
    const userID = 'yh7Bsyo9gE7gdZV4y';

    emailjs
      .send(serviceID, templateID, {
        to_name: 'Chakradhar Nadikota',
        from_name: formData.name,
        message: "Email : "+ formData.email+ " \n " +formData.message ,
        reply_to: formData.email,
      }, userID)
      .then((response) => {
        toast.success("Mail sent to Chakradhar Nadikota");

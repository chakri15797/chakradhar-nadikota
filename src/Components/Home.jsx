    ...
    <div className="profile-container" id='home'>
      <div className="profile">
        ...
        >
                ...
                With nearly four years of experience in software development and design, my current passion lies in crafting web applications. I take pleasure in creating user-friendly interfaces and implementing innovative solutions to ensure smooth and enjoyable user experiences. Keeping myself updated with the latest technologies is essential, 
        ...
        <div className="buttons">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
          >
            <a href='mailto:nadikotachakri@gmail.com?subject=Celebrating Your Success: Welcome Aboard! '>Hire Me</a>
          </motion.button>
          <motion.button
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
          ><a href='/chakradhar_nadikota_resume.pdf' download='Chakradhar Nadikota Resume' target='_blank' rel='noreferrer'>
            Resume</a>
          </motion.button>
        </div>
      </div>
